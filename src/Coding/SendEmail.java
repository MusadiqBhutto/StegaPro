...
public class SendEmail extends javax.swing.JFrame
{
     ...
     private java.io.File showFileDialog(final boolean open)
     {
        ...
        javax.swing.filechooser.FileFilter ff = new javax.swing.filechooser.FileFilter()
        {
           public boolean accept(java.io.File f)
           {
              ...
              if(open) return f.isDirectory() || name.endsWith(".jpg") || name.endsWith(".jpeg") || name.endsWith(".png") || name.endsWith(".gif") || name.endsWith(".txt") || name.endsWith(".pdf") || name.endsWith(".mp3");

              return f.isDirectory() || name.endsWith(".png") || name.endsWith(".pdf") ||    name.endsWith(".txt") ||    name.endsWith(".jpeg") ||    name.endsWith(".mp3");
           }
           public String getDescription()
           {
              if(open)  return "Image (*.jpg, *.jpeg, *.png, *.gif, *.txt, *.pdf, *.mp3)";
        ...
        if(open && fc.showOpenDialog(this) == fc.APPROVE_OPTION)  f = fc.getSelectedFile();
        else if(!open && fc.showSaveDialog(this) == fc.APPROVE_OPTION)  f = fc.getSelectedFile();
        return f;
    ...
    private void jLabelAttachPathMouseClicked(java.awt.event.MouseEvent evt)
    {
       ...
       if(f==null) return;
       else jLabelAttachPath.setText(f.getPath());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt)
    {
       ...
       {
           JOptionPane.showMessageDialog(this, "You Gmail Has 2-Step-verification!" + "please Enter your Gmail App Password instean of Password");
       }
    ...
    {
        jPasswordFrom.setText(""); // Enter Your GmailApp Password
        jTextFrom.setText(""); // Enter your gmail
    }
